            ...
            <div>
              {this.props.data.breakfast
                ? <p className="meal-time">
                    <span className="meal-tag">BREAKFAST:</span>{" "}
                    {this.props.data.breakfast}
                  </p>
                : ""}
              {this.props.data.lunch
                ? <p className="meal-time">
                    <span className="meal-tag">LUNCH:</span>{" "}
                    {this.props.data.lunch}
                  </p>
                : ""}
              {this.props.data.dinner
                ? <p className="meal-time">
                    <span className="meal-tag">DINNER:</span>{" "}
                    {this.props.data.dinner}
                  </p>
                : ""}
        ...
        <div className="row desc-body">
          <div className="col-xs-12 col-sm-10">
            ...
            {this.props.data.website
              ? <a className="website-link" href={this.props.data.website}>
                  WEBSITE
                </a>
              : ""}
          </div>
