    ...
    render() {
        return(
            ...
            <div className="about m-top-three">
                ...
                <blockquote className="blockquote blockquote-reverse clearfix highlight">
                ...
                <Grid>
                    <Row>
                        <Col xs={12} md={7}>
                            ...
                            <br/>
                            <div class="about-p">
                                <p>Is a resource for people struggling with homelessness or poverty in New York City.</p>
                                <p>Our clean & simple application provides the information of all food pantries and shelters in NYC,<br/>
                                as well as other resources, such as public bathrooms, job opportunities and more.</p>
                                <p>Open Arms NYC is a project started by students at General Assembly's Web Development Immersive
                                course in NYC.</p>
                                <p>This application is an educational and not-for-profit service.</p>
                            </div>
                            </div>
                        </Col>
                        <Col xs={12} md={5}>
                            ...
                            <Col xs={12}>
                                <Carousel className="quotes m-top-three">
                                    <Carousel.Item>
                                            ...
                                            <p><br/>I alone cannot change the world. But I can cast a stone across the waters to create many
                                            ripples.</p>
                                            <footer class="blockquote-footer"><cite title="Source Title">Mother Teresa</cite></footer>
                                            </blockquote>
                                    </Carousel.Item>
                                    <Carousel.Item>
                                        <div>
                                            <blockquote className="blockquote blockquotes">
                                            <p><br/>You may not control all the events that happen to you, but you can decide not to be reduced by them.</p>
                                    ...
                                    <Carousel.Item>
                                        <div className="sliderItem">
                                            <blockquote className="blockquote blockquotes">
                                            <p><br/>We must accept finite disappointment, but we must never lose infinite hope.</p>
