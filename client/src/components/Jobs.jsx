...
Phone: (212) 628-5207</p>
        ...
        <div className="row">
            ...
            <div className="panel-body">
                ...
                <div className="media-body">
                <h4 className="media-heading"><a target="_blank" href="http://www.coalitionforthehomeless.org/our-programs/first-step-job-training/first-step/">First Step Job Training Program</a></h4> <h4>First Step helps homeless and low-income <b>women</b> gain the skills, experience and confidence needed to find living-wage jobs.</h4>
                <p>The Coalition’s First Step Job Training Program was launched in 1991 to give homeless and low-income women the training, social support, education and work experience they need to overcome those obstacles, empowering them to build a better life for themselves and their families.

First Step offers six 14-week classes serving roughly 140 women per year. Our innovative curriculum includes over 100 hours of computer instruction, along with literacy workshops, communication and interpersonal skills development, and other hands-on activities that give students a thorough and practical understanding of the job market and workplace. First Step also places students in internships with major corporations or non-profit organizations, and offers ongoing mentoring by experienced professionals.</p>
<br />
<p>If you have questions about First Step or if you would like to sign up for an Informational Session, please call 212-776-2074.</p>
                </div>
                </div>
            </div>
            </div>
...
<br/>
<p>ACE Programs for the Homeless
30-30 Northern Blvd., Ste. B100
...
F: 646-613-8276</p>
        ...
        <div className="row">
            ...
            <div className="panel-body">
                ...
                <div className="media-body">
                <h4 className="media-heading">Henry Street Settlement</h4> <p>Henry Street offers an array of services for individuals seeking employment. Our <a target="_blank" href = "https://www.henrystreet.org/programs/employment/workforce-development-center/?_ga=2.225249946.1066426.1503668698-1110164242.1503498680"> Workforce Development Center (WDC)</a> provides the tools and resources needed to complete a successful job search. This program is also available for non-fluent English speakers, along with <a target="_blank" href="https://www.henrystreet.org/programs/employment/esl-programs/">ESL classes</a>.

We also offer specific employment and training services to people living in the Lillian Wald and Jacob Riis Houses as part of our <a target="_blank" href="https://www.henrystreet.org/programs/employment/jobs-plus-employment-and-training-services/?_ga=2.119966728.1066426.1503668698-1110164242.1503498680">Jobs Plus program.</a></p>
<br/>
<p>Lisa Tomanelli
