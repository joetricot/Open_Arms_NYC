    ...
    render() {
        ...
        <div className="row">
            ...
            <div className="panel-body">
                ...
                management and social services. After 9-12 months, participants graduate from the program with the work and life skills
        ...
        <div className="row">
            ...
            <div className="panel-body">
                ...
                skills training (Occupational Safety & Health Administration [OSHA]; Food Protection) and vocational support services, including life skills
                development and job search assistance. Program activities take place seven days each week year-round, with each participant attending five
                days weekly, graduating from the program once he/she finds full-time employment.</p>
                <br/>
        ...
        <div className="row">
            ...
            <div className="panel-body">
                ...
                <div className="media-body">
                <h4 className="media-heading">Henry Street Settlement</h4> <p>Henry Street offers an array of services
                for individuals seeking employment. Our <a target="_blank" href="https://www.henrystreet.org/programs/employment/workforce-development-center/?_ga=2.225249946.1066426.1503668698-1110164242.1503498680">
                Workforce Development Center (WDC)</a> provides the tools and resources needed to complete a successful job search. This program is also available for non-fluent English speakers, along with
                <a target="_blank" href="https://www.henrystreet.org/programs/employment/esl-programs/">ESL classes</a>.

                We also offer specific employment and training services to people living in the Lillian Wald and Jacob
                Riis Houses as part of our <a target="_blank" href="https://www.henrystreet.org/programs/employment/jobs-plus-employment-and-training-services/?_ga=2.119966728.1066426.1503668698-1110164242.1503498680">Jobs Plus program.</a></p>
                <br/>
                <p>Lisa Tomanelli
