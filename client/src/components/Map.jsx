...
import mealPin from '../meal-pin.svg';
import mealShadow from '../meal-shadow.svg';
import shelterPin from '../shelter-pin.svg';
import shelterShadow from '../shelter-shadow.svg';
const mealIcon = new Icon({
    iconUrl: mealPin,
    shadowUrl: mealShadow,
    iconSize: [40,48],
    shadowSize: [60,48],
    iconAnchor: [20,48],
    shadowAnchor: [10,38],
...
class MyMap extends Component {
    ...
    createMealPopup(meal) {
        if (meal) {
            return (
            <Marker position={[meal.lat,meal.lng]} icon={mealIcon} key={meal.id}
